locals {
  ...
  route_table_ids           = concat([aws_vpc.main.default_route_table_id], local.nat_gateway_route_tables, local.nat_instance_route_tables, var.gateway_endpoint_route_table_ids, aws_route_table.private_no_nat.*.id)
  private_cidr_blocks = [
